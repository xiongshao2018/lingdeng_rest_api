"""
Django settings for lingdeng_rest_api project.
...
ROOT_URLCONF = 'lingdeng_rest_api.urls'
...
WSGI_APPLICATION = 'lingdeng_rest_api.wsgi.application'
...
# 配置ASGI
ASGI_APPLICATION = "lingdeng_rest_api.routing.application"
